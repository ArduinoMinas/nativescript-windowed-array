/**
 * Contains the ObservableWindowedArray class, 
 * which is capable of detecting and responding to changes of a windowed collection 
 * of objects.
 * 
 * @module "nativescirpt-observable-windowed-array"
 */ /** */
 ...
 export interface ObservableArrayDef<T> extends ObservableArray<T>{
  ...
  */
 export class ObservableWindowedArray<T> extends observable.Observable implements ObservableArrayDef<T> {
     /**
